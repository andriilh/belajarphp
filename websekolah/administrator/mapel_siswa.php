...
if($cari){
header("location:nilai.php?nis=$cnis");
}
}
?>
<style type="text/css">
        ...
        <td valign="top"><h2 align="center"><strong>Data Siswa SMA 1 Masbagik </strong></h2>
          ...
          <form id="form2" name="form2" method="post" action="">
			...
			<table width="509" border="1" align="center" cellpadding="1" cellspacing="0">
              <tr>
                <td width="67"><div align="center"><strong>NIS</strong></div></td>
                <td width="170"><div align="center"><strong>Nama Siswa</strong></div></td>
				<td width="74"><div align="center"><strong>Jenis Kelamin</strong></div></td>
                <td width="61"><div align="center"><strong>Smt</strong></div></td>
                <td width="43"><div align="center"><strong>Kelas</strong></div></td>
                <td width="68"><div align="center"><strong>Aksi</strong></div></td>
              </tr>
              <?
...
?>
              <tr>
                ...
                <td><div align="center"><a href="nilai.php?nis=<? echo $data['nis'];?>"><img src="../images/icon/button-edit.gif" width="20" height="20" border="0" /></a></div></td>
				<? } ?>
			  </tr>
				<?
  //pilih data dari tabel siswa
